	...
	$(document).ready(function(){
		...
		$('#Modal_').on('hidden.bs.modal', function (){
			...
			if(article==true){
				if(save==true){
					if ($('.datatables tbody tr.success').hasClass('success')){
						var //barra=$('.datatables tbody tr.success .'+action+'_code').text(),
						desc=$('.datatables tbody tr.success .'+action+'_name').text(),
						...
						tr=tr+'<td><button name="del_art'+counter+'" id="del_art'+counter+'" class="btn btn-default btn-xs" type="button"><i class="fa fa-times"></i></button><input name="cart'+counter+'" id="cart'+counter+'" type="text" disabled="disabled" class="form-control hidden articulos"></td>';
						//tr=tr+'<td><input name="cbarra'+counter+'" id="cbarra'+counter+'" class="form-control" readonly></td>';
						tr=tr+'<td><input name="art'+counter+'" id="art'+counter+'" class="form-control articulos" readonly></td>';
						tr=tr+'<td><select name="und'+counter+'" id="und'+counter+'" class="form-control articulos"></select></td>';
						tr=tr+'<td><input name="cal'+counter+'" id="cant'+counter+'" class="form-control numeric articulos" value="0"></td>';
						tr=tr+'<td><input name="cal'+counter+'" id="costou'+counter+'" class="form-control numeric articulos" value="0"></td>';
						tr=tr+'<td><input name="cal'+counter+'" id="imp'+counter+'" class="form-control numeric articulos"></td>';
						tr=tr+'<td><input name="costot'+counter+'" id="costot'+counter+'" class="form-control articulos" readonly value="0"></td>';
						tr=tr+'</tr>';
		...
		function send(){
			...
			$.ajax({
				url: './modulos/inventario/modulos/inv_recep/index.php',
				type: 'POST',
				data: 'action=new',
				dataType: 'html'
			});			
										...
										<div class="panel panel-default">
											...
											<div class="panel-body">
												<div class="table-responsive">
													<table id="inv_recep_det" class="table table-hover inv_recep_det">
														<thead>
															<tr>
																<th>#</th>
																<th>DESCRIPCION</th>
